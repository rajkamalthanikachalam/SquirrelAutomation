...
public class ReadWriteExcel {
	...
	public static String path = System.getProperty("user.dir")+"\\testdata\\DataSheet.xls";
	...
	public static void main(String arg[]) throws IOException {
		...
		//ReadWriteExcel datatable =new ReadWriteExcel(path);
		
		 datatable = new ReadWriteExcel(System.getProperty("user.dir")+"/testdata/DataSheet.xlsx"); 
		 for(int col=0 ;col<datatable.getColumnCount("Execution"); col++)
		 {
			 System.out.println(datatable.getCellData("Execution", col, 1)); 
		 }
